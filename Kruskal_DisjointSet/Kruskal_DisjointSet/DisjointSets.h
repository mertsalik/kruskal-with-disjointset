...
public:
	...
	void AddElement(DisjointSetItem* setItem);
	...
	static void printElementSets(const DisjointSets & s)
	{
...
private:
	...
	std::vector<DisjointSetItem*> m_nodes; // the list of nodes representing the elements
};
